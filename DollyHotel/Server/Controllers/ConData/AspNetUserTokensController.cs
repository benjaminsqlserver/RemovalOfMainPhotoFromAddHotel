...
namespace DollyHotel.Server.Controllers.ConData
{
    ...
    public partial class AspNetUserTokensController : ODataController
    {
        ...
        public AspNetUserTokensController(DollyHotel.Server.Data.ConDataContext context)
        {
        ...
        public IEnumerable<DollyHotel.Server.Models.ConData.AspNetUserToken> GetAspNetUserTokens()
        {
            var items = this.context.AspNetUserTokens.AsQueryable<DollyHotel.Server.Models.ConData.AspNetUserToken>();
        ...
        partial void OnAspNetUserTokenGet(ref SingleResult<DollyHotel.Server.Models.ConData.AspNetUserToken> item);

        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        [HttpGet("/odata/ConData/AspNetUserTokens(UserId={keyUserId},LoginProvider={keyLoginProvider},Name={keyName})")]
        public SingleResult<DollyHotel.Server.Models.ConData.AspNetUserToken> GetAspNetUserToken([FromODataUri] string keyUserId, [FromODataUri] string keyLoginProvider, [FromODataUri] string keyName)
        {
        ...
        public IActionResult DeleteAspNetUserToken([FromODataUri] string keyUserId, [FromODataUri] string keyLoginProvider, [FromODataUri] string keyName)
        {
            try
            {
                ...
                items = Data.EntityPatch.ApplyTo<DollyHotel.Server.Models.ConData.AspNetUserToken>(Request, items);
        ...
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult PutAspNetUserToken([FromODataUri] string keyUserId, [FromODataUri] string keyLoginProvider, [FromODataUri] string keyName, [FromBody]DollyHotel.Server.Models.ConData.AspNetUserToken item)
        {
            try
            {
                if(!ModelState.IsValid)
        ...
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult PatchAspNetUserToken([FromODataUri] string keyUserId, [FromODataUri] string keyLoginProvider, [FromODataUri] string keyName, [FromBody]Delta<DollyHotel.Server.Models.ConData.AspNetUserToken> patch)
        {
            try
            {
                if(!ModelState.IsValid)
        ...
        [HttpPost]
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult Post([FromBody] DollyHotel.Server.Models.ConData.AspNetUserToken item)
        {
            try
            {
                if(!ModelState.IsValid)
