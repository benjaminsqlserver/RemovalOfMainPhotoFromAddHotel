...
namespace DollyHotel.Server.Controllers.ConData
{
    ...
    public partial class AspNetUserClaimsController : ODataController
    {
        ...
        public AspNetUserClaimsController(DollyHotel.Server.Data.ConDataContext context)
        {
        ...
        public IEnumerable<DollyHotel.Server.Models.ConData.AspNetUserClaim> GetAspNetUserClaims()
        {
            var items = this.context.AspNetUserClaims.AsQueryable<DollyHotel.Server.Models.ConData.AspNetUserClaim>();
        ...
        partial void OnAspNetUserClaimGet(ref SingleResult<DollyHotel.Server.Models.ConData.AspNetUserClaim> item);

        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        [HttpGet("/odata/ConData/AspNetUserClaims(Id={Id})")]
        public SingleResult<DollyHotel.Server.Models.ConData.AspNetUserClaim> GetAspNetUserClaim(int key)
        {
        ...
        public IActionResult DeleteAspNetUserClaim(int key)
        {
            try
            {
                ...
                items = Data.EntityPatch.ApplyTo<DollyHotel.Server.Models.ConData.AspNetUserClaim>(Request, items);
        ...
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult PutAspNetUserClaim(int key, [FromBody]DollyHotel.Server.Models.ConData.AspNetUserClaim item)
        {
            try
            {
                if(!ModelState.IsValid)
        ...
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult PatchAspNetUserClaim(int key, [FromBody]Delta<DollyHotel.Server.Models.ConData.AspNetUserClaim> patch)
        {
            try
            {
                if(!ModelState.IsValid)
        ...
        [HttpPost]
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult Post([FromBody] DollyHotel.Server.Models.ConData.AspNetUserClaim item)
        {
            try
            {
                if(!ModelState.IsValid)
