...
namespace DollyHotel.Server.Controllers.ConData
{
    ...
    public partial class AspNetRoleClaimsController : ODataController
    {
        ...
        public AspNetRoleClaimsController(DollyHotel.Server.Data.ConDataContext context)
        {
        ...
        public IEnumerable<DollyHotel.Server.Models.ConData.AspNetRoleClaim> GetAspNetRoleClaims()
        {
            var items = this.context.AspNetRoleClaims.AsQueryable<DollyHotel.Server.Models.ConData.AspNetRoleClaim>();
        ...
        partial void OnAspNetRoleClaimGet(ref SingleResult<DollyHotel.Server.Models.ConData.AspNetRoleClaim> item);

        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        [HttpGet("/odata/ConData/AspNetRoleClaims(Id={Id})")]
        public SingleResult<DollyHotel.Server.Models.ConData.AspNetRoleClaim> GetAspNetRoleClaim(int key)
        {
        ...
        public IActionResult DeleteAspNetRoleClaim(int key)
        {
            try
            {
                ...
                items = Data.EntityPatch.ApplyTo<DollyHotel.Server.Models.ConData.AspNetRoleClaim>(Request, items);
        ...
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult PutAspNetRoleClaim(int key, [FromBody]DollyHotel.Server.Models.ConData.AspNetRoleClaim item)
        {
            try
            {
                if(!ModelState.IsValid)
        ...
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult PatchAspNetRoleClaim(int key, [FromBody]Delta<DollyHotel.Server.Models.ConData.AspNetRoleClaim> patch)
        {
            try
            {
                if(!ModelState.IsValid)
        ...
        [HttpPost]
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult Post([FromBody] DollyHotel.Server.Models.ConData.AspNetRoleClaim item)
        {
            try
            {
                if(!ModelState.IsValid)
