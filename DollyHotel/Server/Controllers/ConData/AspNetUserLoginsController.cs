...
namespace DollyHotel.Server.Controllers.ConData
{
    ...
    public partial class AspNetUserLoginsController : ODataController
    {
        ...
        public AspNetUserLoginsController(DollyHotel.Server.Data.ConDataContext context)
        {
        ...
        public IEnumerable<DollyHotel.Server.Models.ConData.AspNetUserLogin> GetAspNetUserLogins()
        {
            var items = this.context.AspNetUserLogins.AsQueryable<DollyHotel.Server.Models.ConData.AspNetUserLogin>();
        ...
        partial void OnAspNetUserLoginGet(ref SingleResult<DollyHotel.Server.Models.ConData.AspNetUserLogin> item);

        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        [HttpGet("/odata/ConData/AspNetUserLogins(LoginProvider={keyLoginProvider},ProviderKey={keyProviderKey})")]
        public SingleResult<DollyHotel.Server.Models.ConData.AspNetUserLogin> GetAspNetUserLogin([FromODataUri] string keyLoginProvider, [FromODataUri] string keyProviderKey)
        {
        ...
        public IActionResult DeleteAspNetUserLogin([FromODataUri] string keyLoginProvider, [FromODataUri] string keyProviderKey)
        {
            try
            {
                ...
                items = Data.EntityPatch.ApplyTo<DollyHotel.Server.Models.ConData.AspNetUserLogin>(Request, items);
        ...
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult PutAspNetUserLogin([FromODataUri] string keyLoginProvider, [FromODataUri] string keyProviderKey, [FromBody]DollyHotel.Server.Models.ConData.AspNetUserLogin item)
        {
            try
            {
                if(!ModelState.IsValid)
        ...
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult PatchAspNetUserLogin([FromODataUri] string keyLoginProvider, [FromODataUri] string keyProviderKey, [FromBody]Delta<DollyHotel.Server.Models.ConData.AspNetUserLogin> patch)
        {
            try
            {
                if(!ModelState.IsValid)
        ...
        [HttpPost]
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult Post([FromBody] DollyHotel.Server.Models.ConData.AspNetUserLogin item)
        {
            try
            {
                if(!ModelState.IsValid)
