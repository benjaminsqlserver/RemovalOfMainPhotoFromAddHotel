...
namespace DollyHotel.Server.Controllers.ConData
{
    ...
    public partial class AspNetUserRolesController : ODataController
    {
        ...
        public AspNetUserRolesController(DollyHotel.Server.Data.ConDataContext context)
        {
        ...
        public IEnumerable<DollyHotel.Server.Models.ConData.AspNetUserRole> GetAspNetUserRoles()
        {
            var items = this.context.AspNetUserRoles.AsQueryable<DollyHotel.Server.Models.ConData.AspNetUserRole>();
        ...
        partial void OnAspNetUserRoleGet(ref SingleResult<DollyHotel.Server.Models.ConData.AspNetUserRole> item);

        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        [HttpGet("/odata/ConData/AspNetUserRoles(UserId={keyUserId},RoleId={keyRoleId})")]
        public SingleResult<DollyHotel.Server.Models.ConData.AspNetUserRole> GetAspNetUserRole([FromODataUri] string keyUserId, [FromODataUri] string keyRoleId)
        {
        ...
        public IActionResult DeleteAspNetUserRole([FromODataUri] string keyUserId, [FromODataUri] string keyRoleId)
        {
            try
            {
                ...
                items = Data.EntityPatch.ApplyTo<DollyHotel.Server.Models.ConData.AspNetUserRole>(Request, items);
        ...
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult PutAspNetUserRole([FromODataUri] string keyUserId, [FromODataUri] string keyRoleId, [FromBody]DollyHotel.Server.Models.ConData.AspNetUserRole item)
        {
            try
            {
                if(!ModelState.IsValid)
        ...
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult PatchAspNetUserRole([FromODataUri] string keyUserId, [FromODataUri] string keyRoleId, [FromBody]Delta<DollyHotel.Server.Models.ConData.AspNetUserRole> patch)
        {
            try
            {
                if(!ModelState.IsValid)
        ...
        [HttpPost]
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult Post([FromBody] DollyHotel.Server.Models.ConData.AspNetUserRole item)
        {
            try
            {
                if(!ModelState.IsValid)
